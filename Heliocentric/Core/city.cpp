...
City::City(Player* owner, Attack* attack, int def, int heal, int pr, int pop, Slot* assigned_slot) :
	AttackableGameObject(assigned_slot->get_absolute_position(), owner, attack, def, heal), production(pr), population(pop), slot(assigned_slot) {}


City::City(UID id, Player* owner, Attack* attack, int def, int heal, int pr, int pop, Slot* assigned_slot) :
	AttackableGameObject(id, assigned_slot->get_absolute_position(), owner, attack, def, heal), production(pr), population(pop), slot(assigned_slot) {}
