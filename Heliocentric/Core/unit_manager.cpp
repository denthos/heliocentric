...
UnitManager::UnitManager() {
	...
	this->active_units.insert(std::make_unique<Unit>(glm::vec3(0.0f, 0.0f, 0.0f), p1, 25, 1, 50, 100, 1));
	this->idle_units.insert(std::make_unique<Unit>(glm::vec3(0.0f, 0.0f, 0.0f), p1, 5, 1, 50, 100, 1));
