...
std::unordered_map<BuildingType::TypeIdentifier, BuildingType*> BuildingType::buildingTypeMap = {
	{
		...
		new BuildingTypeImpl<FissionPlant>(TypeIdentifier::FISSION_PLANT, 100, "Fission Power Plant", 0, FISSION_PLANT_PRODUCTION, 0)
	},

	{
		BuildingType::TypeIdentifier::FUSION_PLANT,
		new BuildingTypeImpl<FusionPlant>(TypeIdentifier::FUSION_PLANT, 200, "Fusion Power Plant", 0, FUSION_PLANT_PRODUCTION, 0)
	},
	
	{
		BuildingType::TypeIdentifier::RESEARCH_FACILITY,
		new BuildingTypeImpl<ResearchFacility>(TypeIdentifier::RESEARCH_FACILITY, 100, "Research Facility", 0, 0, RESEARCH_FACILITY_SCIENCE)
	}
};